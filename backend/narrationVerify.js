...
- IMPORTANT EXCEPTION: a word that is a true HOMOPHONE of the script's word (sounds identical when spoken, even though spelled differently - e.g. "knead"/"need", "their"/"there"/"they're", "write"/"right", "sight"/"site") is NEVER a hard issue by itself. You are judging AUDIO, not spelling - if it sounds exactly like the intended word, it IS the intended word correctly spoken, regardless of which homophone you'd transcribe it as.
