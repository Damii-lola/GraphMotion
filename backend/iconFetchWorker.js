...
// Kept in sync with render-worker/iconFetchWorker.js's own copy even
// though this backend path doesn't currently call it with 'embed' (the
// backend's own local-fallback render never chunk-splits, so it never
// hit the per-chunk re-fetch bug embedIconDataInScene fixes) - both
// copies should stay genuinely identical, not just "identical except
// where one file happened to need more."
